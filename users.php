...
require "../index.php/create_new_user_admin/function_for_create_user.php";

logen("oliver.kopyov@smartadminwebapp.com","123");
var_dump(logen());
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="register/page_login.php">Войти</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="edit/edit.php?id=<?php echo $user['id']?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="profile/page_profile.php?id=<?php echo $user['id']?>">
                                            <i class="fa fa-edit"></i>
                                            Профиль</a>
                                        <a class="dropdown-item" href="security/security.php?id=<?php echo $user['id']?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="status/status.php?id=<?php echo $user['id']?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="avatar/media.php?id=<?php echo $user['id']?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="delete/delete.php?id=<?php echo $user['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
