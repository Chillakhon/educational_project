        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            <div class="subheader">
                <h1 class="subheader-title">
                    <i class='subheader-icon fal fa-user'></i> <?php echo $users['username']?>
                </h1>
            </div>
            <div class="row">
                        ...
                        <div class="row no-gutters row-grid">
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    <img src="../<?php echo $users['image']?>" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                    <h5 class="mb-0 fw-700 text-center mt-3">
                                        <?php echo $users['username']?>
                                        <small class="text-muted mb-0"><?php echo $users['job_title']?></small>
                                    </h5>
                            ...
                            <div class="col-12">
                                <div class="p-3 text-center">
                                    ...
                                    <address class="fs-sm fw-400 mt-4 text-muted">
                                        <i class="fas fa-map-pin mr-2"></i> <?php echo $users['adress']?>
                                    </address>
                                </div>
                            </div>
                        </div>
